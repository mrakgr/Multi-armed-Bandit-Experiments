...
extern "C" {
    ...
    __device__ __forceinline__ Union0 make_Union0Case0(Tuple1 v) {
        Union0 t;
        t.tag = 0;
        t.data.Union0Case0 = v;
        return t;
    }
...
and method_5((var_0: uint64), (var_1: System.Collections.Generic.Stack<Env4>), (var_2: uint64), (var_3: int64)): EnvStack3 =
    ...
    let (var_8: (Union1 ref)) = (ref (Union1Case0(Tuple2(var_7))))
    let (var_9: EnvStack3) = EnvStack3((var_8: (Union1 ref)))
