...
// Cuda method call
// method_2((var_131: int64), (var_132: int64))
let (var_133: (System.Object [])) = Array.zeroCreate<System.Object> (System.Convert.ToInt32(2L))
var_133.[int32 0L] <- (var_131 :> System.Object)
var_133.[int32 1L] <- (var_132 :> System.Object)
let (var_134: ManagedCuda.CudaStream) = ManagedCuda.CudaStream()
let (var_135: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_2", var_124, var_11)
let (var_136: ManagedCuda.BasicTypes.CUstream) = var_134.get_Stream()
var_135.RunAsync(var_136, var_133)
