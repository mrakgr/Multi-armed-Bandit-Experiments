...
let cases_all expr =
    [case_inl_pat_statement; case_inl_name_pat_list_statement; case_inl_rec_name_pat_list_statement; case_inl_name_pat_list_statement
     case_inl_rec_name_pat_list_statement; case_inl_pat_expr; case_inl_rec_name_pat_list_expr; case_inl_rec_name_pat_list_expr; case_expr]
...
l (S "add") (inl' [S "x"; S "y"; S "z"] (V "x" + V "y" + V "z"))
    (ap' (V "add") [LitInt32 1; LitInt32 2; LitInt32 3])