...
and method_16((var_4: string), (var_5: int64), (var_6: int64)): unit =
    ...
    if (var_23 && var_25) then
        ...
        if (var_28 || var_31) then
            ...
            if (var_45 > 0L) then
                method_17((var_45: int64), (var_5: int64), (var_4: string), (var_6: int64))
                ()
            else
        ...
        let (var_67: int64) = (var_5 * var_5)
        if (var_67 > 0L) then
            method_17((var_67: int64), (var_5: int64), (var_4: string), (var_6: int64))
            ()
        else
            (failwith "n in parse array must be > 0.")
        ()
    ()
and method_17((var_0: int64), (var_3: int64), (var_6: string), (var_7: int64)): unit =
    ...
    if (var_30 && var_32) then
        ...
        if (var_35 && var_36) then
            ...
            method_18((var_0: int64), (var_3: int64), (var_6: string), (var_40: int64), (var_34: int64))
            ()
        else
            (failwith "pint64")
        ()
        ...
        (failwith "pint64")
    ()
and method_18((var_0: int64), (var_3: int64), (var_6: string), (var_7: int64), (var_8: int64)): unit =
    ...
    if (var_31 && var_33) then
        ...
        if (var_36 && var_37) then
            ...
            method_18((var_0: int64), (var_3: int64), (var_6: string), (var_42: int64), (var_35: int64))
            ()
        else
...
and method_20((var_0: (int64 [])), (var_1: int64), (var_4: string), (var_5: int64), (var_6: int64), (var_9: int64)): unit =
    if (var_5 < var_6) then
        method_21((var_0: (int64 [])), (var_5: int64), (var_6: int64), (var_1: int64), (var_4: string), (var_9: int64))
        ()
    else
        let (var_27: int64) = 0L
        let (var_28: Tuple4) = method_24((var_27: int64), (var_0: (int64 [])), (var_1: int64))
        let (var_29: int64) = var_28.mem_0
        let (var_30: int64) = var_28.mem_1
        ...
        let (if_var_1: int64) =
            if (var_31 >= 0L) then
                ...
                (-var_31)
        let (var_32: int64) = if_var_1
        System.Console.WriteLine(var_32)
        ()
    ()
and method_21((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_5: int64), (var_8: string), (var_9: int64)): unit =
    ...
    if (var_32 && var_34) then
        ...
        if (var_37 && var_38) then
            ...
            method_22((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_5: int64), (var_8: string), (var_42: int64), (var_36: int64))
            ()
        else
            (failwith "pint64")
        ()
        ...
        (failwith "pint64")
    ()
and method_22((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_5: int64), (var_8: string), (var_9: int64), (var_10: int64)): unit =
    ...
    if (var_33 && var_35) then
        ...
        if (var_38 && var_39) then
            ...
            method_22((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_5: int64), (var_8: string), (var_44: int64), (var_37: int64))
            ()
        else
...
and method_24((var_0: int64), (var_1: (int64 [])), (var_2: int64)): Tuple4 =
    let (if_var_2: Tuple4) =
        if (var_0 < var_2) then
            ...
            let (var_22: Tuple4) = method_25((var_11: int64), (var_21: int64), (var_3: int64), (var_1: (int64 [])), (var_2: int64))
            var_22
        else
            Tuple4(0L, 0L)
    if_var_2
and method_25((var_0: int64), (var_1: int64), (var_2: int64), (var_3: (int64 [])), (var_4: int64)): Tuple4 =
    let (if_var_3: Tuple4) =
        if (var_2 < var_4) then
            ...
            let (var_24: Tuple4) = method_25((var_13: int64), (var_23: int64), (var_5: int64), (var_3: (int64 [])), (var_4: int64))
            var_24
        else
            Tuple4(var_0, var_1)
    if_var_3
...
method_14((var_32: string), (var_34: int64))
