    ...
    if var_8 then
        ...
        if var_11 then
            ...
            if var_14 then
                ...
                if var_15 then
                    ...
                    method_21((var_16: bool), (var_0: int64), (var_1: int64), (var_2: int64), (var_3: string), (var_12: int64))
                else
                    let (var_17: bool) = true
                    method_21((var_17: bool), (var_0: int64), (var_1: int64), (var_2: int64), (var_3: string), (var_5: int64))
            else
                let (var_18: bool) = true
                method_21((var_18: bool), (var_0: int64), (var_1: int64), (var_2: int64), (var_3: string), (var_5: int64))
    else
        let (var_20: bool) =
            if (var_5 >= 0L) then
        ...
        if var_20 then
            ...
            if var_22 then
                ...
                method_21((var_24: bool), (var_0: int64), (var_1: int64), (var_2: int64), (var_3: string), (var_23: int64))
            else
                let (var_25: bool) = true
                method_21((var_25: bool), (var_0: int64), (var_1: int64), (var_2: int64), (var_3: string), (var_5: int64))
        else
            let (var_26: bool) = true
            method_21((var_26: bool), (var_0: int64), (var_1: int64), (var_2: int64), (var_3: string), (var_5: int64))
and method_21((var_0: bool), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: string), (var_5: int64)): unit =
    let (var_7: bool) =
        if (var_5 >= 0L) then
    ...
    if var_7 then
        ...
        if var_9 then
            ...
            method_22((var_0: bool), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: string), (var_14: int64), (var_10: int64))
        else
            (failwith "pint64")
    else
        (failwith "pint64")
and method_22((var_0: bool), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: string), (var_5: int64), (var_6: int64)): unit =
    let (var_8: bool) =
        if (var_6 >= 0L) then
    ...
    if var_8 then
        ...
        if var_10 then
            ...
            if var_16 then
                ...
                method_22((var_0: bool), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: string), (var_18: int64), (var_11: int64))
            else
                (failwith "integer overflow")
        else
            let (var_19: int64) =
                if var_0 then
                    ...
                    (-var_5)
            let (var_20: int64) = 0L
            method_23((var_19: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: string), (var_20: int64), (var_6: int64))
    else
        let (var_21: int64) =
            if var_0 then
                var_5
                ...
                (-var_5)
        let (var_22: int64) = 0L
        method_23((var_21: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: string), (var_22: int64), (var_6: int64))
and method_23((var_0: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: string), (var_5: int64), (var_6: int64)): unit =
    ...
    if var_9 then
        ...
        if var_12 then
            method_23((var_0: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: string), (var_7: int64), (var_13: int64))
        else
            let (var_15: bool) =
                if (var_0 = 1L) then
                    true
            ...
            method_17((var_4: string), (var_2: int64), (var_3: int64), (var_6: int64))
    else
        let (var_18: bool) =
            if (var_0 = 1L) then
                true
