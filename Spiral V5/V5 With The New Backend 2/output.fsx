let rec method_14((var_4: string), (var_5: int64)): unit =
    ...
    if (var_28 && var_30) then
        ...
        if (var_33 && var_34) then
            ...
            method_15((var_4: string), (var_38: int64), (var_32: int64))
            ()
        else
            ()
        ()
        ...
        ()
    ()
and method_15((var_4: string), (var_5: int64), (var_6: int64)): unit =
    ...
    if (var_29 && var_31) then
        ...
        if (var_34 && var_35) then
            ...
            method_15((var_4: string), (var_40: int64), (var_33: int64))
            ()
        else
...
and method_16((var_4: string), (var_5: int64), (var_6: int64)): unit =
    ...
    if (var_23 && var_25) then
        ...
        if (var_28 || var_31) then
            ...
            if (var_5 > 0L) then
                method_17((var_5: int64), (var_4: string), (var_6: int64))
                ()
            else
                ()
            ()
        ...
        ()
    ()
and method_17((var_0: int64), (var_5: string), (var_6: int64)): unit =
    let (var_29: bool) = (var_6 >= 0L)
    ...
    if (var_29 && var_31) then
        ...
        if (var_34 && var_35) then
            ...
            method_18((var_0: int64), (var_5: string), (var_39: int64), (var_33: int64))
            ()
        else
            ()
        ()
        ...
        ()
    ()
and method_18((var_0: int64), (var_5: string), (var_6: int64), (var_7: int64)): unit =
    ...
    if (var_30 && var_32) then
        ...
        if (var_35 && var_36) then
            ...
            method_18((var_0: int64), (var_5: string), (var_41: int64), (var_34: int64))
            ()
        else
            method_19((var_0: int64), (var_5: string), (var_6: int64), (var_34: int64))
            ()
        ()
    else
        method_19((var_0: int64), (var_5: string), (var_6: int64), (var_7: int64))
        ()
    ()
and method_19((var_0: int64), (var_5: string), (var_6: int64), (var_7: int64)): unit =
    ...
    if (var_24 && var_26) then
        ...
        if (var_29 || var_32) then
            method_19((var_0: int64), (var_5: string), (var_6: int64), (var_28: int64))
            ()
        else
            let (var_46: (int64 [])) = Array.zeroCreate<int64> (System.Convert.ToInt32(var_0))
            var_46.[int32 0L] <- var_6
            let (var_48: int64) = 1L
            method_20((var_46: (int64 [])), (var_5: string), (var_48: int64), (var_0: int64), (var_7: int64))
            ()
        ()
    else
        ...
        let (var_62: int64) = 1L
        method_20((var_60: (int64 [])), (var_5: string), (var_62: int64), (var_0: int64), (var_7: int64))
        ()
    ()
and method_20((var_0: (int64 [])), (var_3: string), (var_4: int64), (var_5: int64), (var_8: int64)): unit =
    if (var_4 < var_5) then
        method_21((var_0: (int64 [])), (var_4: int64), (var_5: int64), (var_3: string), (var_8: int64))
        ()
    else
        let (var_22: int64) = 0L
        let (var_23: int64) = method_24((var_0: (int64 [])), (var_22: int64))
        System.Console.WriteLine(var_23)
        ()
    ()
and method_21((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_7: string), (var_8: int64)): unit =
    ...
    if (var_31 && var_33) then
        ...
        if (var_36 && var_37) then
            ...
            method_22((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_7: string), (var_41: int64), (var_35: int64))
            ()
        else
            ()
        ()
        ...
        ()
    ()
and method_22((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_7: string), (var_8: int64), (var_9: int64)): unit =
    ...
    if (var_32 && var_34) then
        ...
        if (var_37 && var_38) then
            ...
            method_22((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_7: string), (var_43: int64), (var_36: int64))
            ()
        else
            method_23((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_7: string), (var_8: int64), (var_36: int64))
            ()
        ()
    else
        method_23((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_7: string), (var_8: int64), (var_9: int64))
        ()
    ()
and method_23((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_7: string), (var_8: int64), (var_9: int64)): unit =
    ...
    if (var_26 && var_28) then
        ...
        if (var_31 || var_34) then
            method_23((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_7: string), (var_8: int64), (var_30: int64))
            ()
        else
            var_0.[int32 var_1] <- var_8
            let (var_49: int64) = (var_1 + 1L)
            method_20((var_0: (int64 [])), (var_7: string), (var_49: int64), (var_2: int64), (var_9: int64))
            ()
        ()
    else
        var_0.[int32 var_1] <- var_8
        let (var_62: int64) = (var_1 + 1L)
        method_20((var_0: (int64 [])), (var_7: string), (var_62: int64), (var_2: int64), (var_9: int64))
        ()
    ()
and method_24((var_0: (int64 [])), (var_1: int64)): int64 =
    ...
    let (if_var_1: int64) =
        if (var_1 < var_2) then
            ...
            let (var_6: int64) = method_25((var_0: (int64 [])), (var_3: int64), (var_5: int64))
            var_6
        else
            0L
    if_var_1
and method_25((var_0: (int64 [])), (var_1: int64), (var_2: int64)): int64 =
    ...
    let (if_var_2: int64) =
        if (var_1 < var_3) then
            ...
            let (var_7: int64) = method_25((var_0: (int64 [])), (var_4: int64), (var_6: int64))
            var_7
        else
            var_2
    if_var_2
