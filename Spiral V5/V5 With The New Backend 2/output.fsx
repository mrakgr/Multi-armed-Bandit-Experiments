...
and method_43((var_0: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_10: string), (var_11: int64), (var_12: int64)): unit =
    ...
    if var_15 then
        ...
        if var_18 then
            ...
            let (var_20: int64) = (0L + var_9)
            let (var_21: int64) = (var_20 + var_8)
            let (var_22: int64) = (var_21 + var_7)
            let (var_23: int64) = (var_22 + var_6)
            let (var_24: int64) = (var_23 + var_5)
            let (var_25: int64) = (var_24 + var_4)
            let (var_26: int64) = (var_25 + var_3)
            let (var_27: int64) = (var_26 + var_2)
            let (var_28: int64) = (var_27 + var_1)
            let (var_29: int64) = (var_28 + var_0)
            System.Console.WriteLine(var_29)
    else
        let (var_30: int64) = (0L + var_9)
        let (var_31: int64) = (var_30 + var_8)
        let (var_32: int64) = (var_31 + var_7)
        let (var_33: int64) = (var_32 + var_6)
        let (var_34: int64) = (var_33 + var_5)
        let (var_35: int64) = (var_34 + var_4)
        let (var_36: int64) = (var_35 + var_3)
        let (var_37: int64) = (var_36 + var_2)
        let (var_38: int64) = (var_37 + var_1)
