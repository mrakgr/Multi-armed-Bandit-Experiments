    ...
    if var_6 then
        ...
        | Union2Case0(var_13) ->
            ...
            | Union2Case0(var_18) ->
                ...
                method_51((var_25: (bool [])), (var_23: int64), (var_1: int64), (var_22: int64), (var_21: int64), (var_35: string), (var_36: string), (var_37: string), (var_38: string), (var_40: (Union6 ref)), (var_39: (Tuple4 [])))
            | Union2Case1 ->
...
and method_42((var_0: int64), (var_1: (bool [])), (var_2: int64), (var_3: int64), (var_4: int64)): int64 =
    if (var_3 < var_2) then
        ...
        var_4
and method_51((var_0: (bool [])), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: string), (var_6: string), (var_7: string), (var_8: string), (var_9: (Union6 ref)), (var_10: (Tuple4 []))): unit =
    ...
    method_53((var_111: ((Tuple4 []) [])), (var_10: (Tuple4 [])), (var_0: (bool [])), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: string), (var_6: string), (var_7: string), (var_8: string), (var_9: (Union6 ref)), (var_11: int64), (var_112: int64))
    let (var_113: int64) = 0L
    let (var_114: int64) = var_111.LongLength
    let (var_115: int64) = 0L
    let (var_116: int64) = method_54((var_111: ((Tuple4 []) [])), (var_114: int64), (var_115: int64), (var_113: int64))
    ...
    let (var_121: int64) = method_55((var_111: ((Tuple4 []) [])), (var_117: (Tuple4 [])), (var_119: int64), (var_120: int64), (var_118: int64))
    ...
    | Union6Case0(var_123) ->
        ...
        method_57((var_127: Rec5))
    | Union6Case1 ->
        method_51((var_0: (bool [])), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: string), (var_6: string), (var_7: string), (var_8: string), (var_9: (Union6 ref)), (var_117: (Tuple4 [])))
and method_53((var_0: ((Tuple4 []) [])), (var_1: (Tuple4 [])), (var_2: (bool [])), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: int64), (var_7: string), (var_8: string), (var_9: string), (var_10: string), (var_11: (Union6 ref)), (var_12: int64), (var_13: int64)): unit =
    if (var_13 < var_12) then
        ...
        method_53((var_0: ((Tuple4 []) [])), (var_1: (Tuple4 [])), (var_2: (bool [])), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: int64), (var_7: string), (var_8: string), (var_9: string), (var_10: string), (var_11: (Union6 ref)), (var_12: int64), (var_112: int64))
    else
        ()
and method_54((var_0: ((Tuple4 []) [])), (var_1: int64), (var_2: int64), (var_3: int64)): int64 =
    if (var_2 < var_1) then
        let (var_4: (Tuple4 [])) = var_0.[int32 var_2]
        let (var_5: int64) = var_4.LongLength
        let (var_6: int64) = (var_3 + var_5)
        let (var_7: int64) = (var_2 + 1L)
        method_54((var_0: ((Tuple4 []) [])), (var_1: int64), (var_7: int64), (var_6: int64))
    else
        var_3
and method_55((var_0: ((Tuple4 []) [])), (var_1: (Tuple4 [])), (var_2: int64), (var_3: int64), (var_4: int64)): int64 =
    if (var_3 < var_2) then
        let (var_5: (Tuple4 [])) = var_0.[int32 var_3]
        let (var_6: int64) = var_5.LongLength
        let (var_7: int64) = 0L
        let (var_8: int64) = method_56((var_5: (Tuple4 [])), (var_1: (Tuple4 [])), (var_6: int64), (var_7: int64), (var_4: int64))
        let (var_9: int64) = (var_3 + 1L)
        method_55((var_0: ((Tuple4 []) [])), (var_1: (Tuple4 [])), (var_2: int64), (var_9: int64), (var_8: int64))
    else
        var_4
and method_56((var_0: (Tuple4 [])), (var_1: (Tuple4 [])), (var_2: int64), (var_3: int64), (var_4: int64)): int64 =
    if (var_3 < var_2) then
        let (var_5: Tuple4) = var_0.[int32 var_3]
        ...
        let (var_9: int64) = (var_3 + 1L)
        method_56((var_0: (Tuple4 [])), (var_1: (Tuple4 [])), (var_2: int64), (var_9: int64), (var_8: int64))
    else
        var_4
and method_57((var_0: Rec5)): unit =
    match var_0 with
    | Rec5Case0 ->
        ()
    | Rec5Case1(var_2) ->
