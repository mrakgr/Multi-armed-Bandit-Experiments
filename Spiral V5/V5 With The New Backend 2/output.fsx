...
and method_15((var_0: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: int64)): unit =
    if (var_6 < var_5) then
        ...
        if var_7 then
            ...
            method_16((var_0: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_8: int64))
        else
            let (var_9: bool) =
                if (var_4 = var_2) then
                    (var_6 = var_3)
            ...
            if var_9 then
                ...
                method_15((var_0: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_11: int64))
    else
        let (var_12: int64) = (var_4 + 1L)
        method_14((var_0: int64), (var_1: int64), (var_5: int64), (var_2: int64), (var_3: int64), (var_12: int64))
    ...
    if (var_6 < var_5) then
        ...
        if var_7 then
            ...
            if var_9 then
                ...
                let (var_10: int64) = (var_6 + 1L)
                method_16((var_0: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_10: int64))
    else
        let (var_11: int64) = (var_4 + 1L)
        method_17((var_0: int64), (var_1: int64), (var_5: int64), (var_2: int64), (var_3: int64), (var_11: int64))
    ...
    if (var_6 < var_5) then
        ...
        if var_7 then
            ...
            if var_8 then
                ...
                method_18((var_0: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_9: int64))
            else
                let (var_10: int64) = (var_6 + 1L)
                method_18((var_0: int64), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_10: int64))
    else
        let (var_11: int64) = (var_4 + 1L)
        method_19((var_0: int64), (var_1: int64), (var_5: int64), (var_2: int64), (var_3: int64), (var_11: int64))
