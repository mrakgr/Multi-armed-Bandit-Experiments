...
let rec method_14 ((var_2: string)) ((var_0: int64), (var_1: Env0)): unit =
    ...
    method_20((var_6: (int64 * Env0 -> unit)), (var_2: string), (var_3: int64))
and method_15 ((var_2: int64), (var_3: string)) ((var_0: int64), (var_1: Env0)): unit =
    ...
    method_20((var_7: (int64 * Env0 -> unit)), (var_3: string), (var_4: int64))
and method_16 ((var_2: int64), (var_3: int64), (var_4: string)) ((var_0: int64), (var_1: Env0)): unit =
    ...
    method_20((var_8: (int64 * Env0 -> unit)), (var_4: string), (var_5: int64))
and method_17 ((var_2: int64), (var_3: int64), (var_4: int64), (var_5: string)) ((var_0: int64), (var_1: Env0)): unit =
    ...
    method_20((var_9: (int64 * Env0 -> unit)), (var_5: string), (var_6: int64))
and method_18 ((var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: string)) ((var_0: int64), (var_1: Env0)): unit =
    ...
    method_20((var_10: (int64 * Env0 -> unit)), (var_6: string), (var_7: int64))
and method_19 ((var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: int64), (var_7: string)) ((var_0: int64), (var_1: Env0)): unit =
    ...
    let (var_9: int64) = (0L + var_6)
    let (var_10: int64) = (var_9 + var_5)
    let (var_11: int64) = (var_10 + var_4)
    let (var_12: int64) = (var_11 + var_3)
    let (var_13: int64) = (var_12 + var_2)
    let (var_14: int64) = (var_13 + var_0)
    System.Console.WriteLine(var_14)
and method_20((var_0: (int64 * Env0 -> unit)), (var_1: string), (var_2: int64)): unit =
    let (var_4: bool) =
        if (var_2 >= 0L) then
    ...
    if var_4 then
        ...
        if var_6 then
            ...
            method_21((var_0: (int64 * Env0 -> unit)), (var_1: string), (var_11: int64), (var_7: int64))
        else
            (failwith "pint64")
    else
        (failwith "pint64")
and method_21((var_0: (int64 * Env0 -> unit)), (var_1: string), (var_2: int64), (var_3: int64)): unit =
    let (var_5: bool) =
        if (var_3 >= 0L) then
    ...
    if var_5 then
        ...
        if var_7 then
            ...
            if var_13 then
                ...
                method_21((var_0: (int64 * Env0 -> unit)), (var_1: string), (var_15: int64), (var_8: int64))
            else
                (failwith "integer overflow")
        else
            let (var_16: int64) = 0L
            method_22((var_2: int64), (var_0: (int64 * Env0 -> unit)), (var_1: string), (var_16: int64), (var_8: int64))
    else
        let (var_17: int64) = 0L
        method_22((var_2: int64), (var_0: (int64 * Env0 -> unit)), (var_1: string), (var_17: int64), (var_3: int64))
and method_22((var_0: int64), (var_1: (int64 * Env0 -> unit)), (var_2: string), (var_3: int64), (var_4: int64)): unit =
    ...
    if var_7 then
        ...
        if var_10 then
            method_22((var_0: int64), (var_1: (int64 * Env0 -> unit)), (var_2: string), (var_5: int64), (var_11: int64))
        else
