    ...
    if var_6 then
        ...
        if var_9 then
            ...
            if var_11 then
                ...
                let (var_13: int64) = 0L
                method_17((var_12: (int64 [])), (var_1: string), (var_13: int64), (var_0: int64), (var_3: int64))
            else
        ...
        if var_14 then
            ...
            let (var_16: int64) = 0L
            method_17((var_15: (int64 [])), (var_1: string), (var_16: int64), (var_0: int64), (var_3: int64))
        else
            (failwith "n in parse array must be >= 0")
and method_17((var_0: (int64 [])), (var_1: string), (var_2: int64), (var_3: int64), (var_4: int64)): unit =
    ...
    if var_5 then
        ...
        if var_8 then
            ...
            if var_10 then
                ...
                method_18((var_12: bool), (var_0: (int64 [])), (var_2: int64), (var_6: int64), (var_3: int64), (var_1: string), (var_11: int64))
            else
                let (var_13: bool) = true
                method_18((var_13: bool), (var_0: (int64 [])), (var_2: int64), (var_6: int64), (var_3: int64), (var_1: string), (var_4: int64))
        else
            let (var_14: bool) = true
            method_18((var_14: bool), (var_0: (int64 [])), (var_2: int64), (var_6: int64), (var_3: int64), (var_1: string), (var_4: int64))
    else
        let (var_15: int64) = System.Int64.MinValue
        let (var_16: int64) = 0L
        let (var_17: int64) = var_0.LongLength
        let (var_18: int64) = 0L
        let (var_19: Tuple0) = method_21((var_0: (int64 [])), (var_17: int64), (var_18: int64), (var_16: int64), (var_15: int64))
...
and method_20((var_0: int64), (var_1: (int64 [])), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: string), (var_6: int64), (var_7: int64)): unit =
    ...
    if var_10 then
        ...
        if var_13 then
            ...
            method_17((var_1: (int64 [])), (var_5: string), (var_3: int64), (var_4: int64), (var_7: int64))
    else
        var_1.[int32 var_2] <- var_0
        method_17((var_1: (int64 [])), (var_5: string), (var_3: int64), (var_4: int64), (var_7: int64))
and method_21((var_0: (int64 [])), (var_1: int64), (var_2: int64), (var_3: int64), (var_4: int64)): Tuple0 =
    if (var_2 < var_1) then
        ...
        method_21((var_0: (int64 [])), (var_1: int64), (var_11: int64), (var_9: int64), (var_10: int64))
    else
        Tuple0(var_3, var_4)
